...
@Component({
  selector: 'app-bootstrap-type-ahead-demo',
  templateUrl: './bootstrap-type-ahead-demo.component.html',
  styleUrls: ['./bootstrap-type-ahead-demo.component.scss']
})
export class BootstrapTypeAheadDemoComponent implements OnInit {
